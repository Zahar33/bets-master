...
<body>
<%--@elvariable id="loggedCustomer" type="com.example.model.Customer"--%>
<%--@elvariable id="bookmaker" type="com.example.model.Person"--%>
<div id="header">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-1 col-lg-1">
                                    <ruby><fmt:formatNumber
                                            value="${loggedCustomer.personsPurse.balance.getAmount().doubleValue()}"/>
                                        <rt>${balance}</rt>
                    ...
                    <c:if test="${role.equals('bookmaker')}">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-1 col-lg-1">
                                    <ruby><fmt:formatNumber
                                            value="${bookmaker.personsPurse.balance.amount.doubleValue()}"/>
                                        <rt>${balance}</rt>
