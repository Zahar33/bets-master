        ...
        <div class="col-lg-10 " align="center">
            <form role="form" action="${login_url}" method="POST">
                <div class="form-group">
                    ...
                    <label for="pass" class="control-label">Captcha</label> <br/> <br/>
                    <input type="text" id="pass" name="captcha" value=""><br/><br/>
                    <c:if test="${not empty loginError}">
                        <p class="alert alert-danger" style="width: 250px;height: auto">${loginError}</p>
                    </c:if>
